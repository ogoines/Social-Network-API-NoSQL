...
**Schema Settings**:11111111111111111
...
1111111111111
- `GET` to get a single thought by its `_id` 'getThoughtById' 1111111111111

- `POST` to create a new thought (don't forget to push the created thought's `_id` to the associated user's `thoughts` array field)  'createThought' 11111111111111
...
- `DELETE` to remove a thought by its `_id` 'removeThought' 11111111111111
